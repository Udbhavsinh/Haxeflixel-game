...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("GameProject", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("GameProject", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "";
		app.meta["file"] = "GameProject";
		app.meta["name"] = "Game Project";
